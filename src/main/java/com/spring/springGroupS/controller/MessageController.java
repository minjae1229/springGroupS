...
public class MessageController {
	...
	public String getMessage(Model model,
		...
		if(msgFlag.equals("hoewonInputOk")) { // 여기서 메시지와 url 결정
			...
			model.addAttribute("message", "회원삭제 성공");
			model.addAttribute("url", "/user2/userList");
		}
			...
			model.addAttribute("message", "회원 정보 수정되었습니다.");
			...
			model.addAttribute("message", "방명록 등록성공.");
			...
			model.addAttribute("message", "방명록 게시글이 삭제 실패.");
			model.addAttribute("url", "/guest/guestList");
		}
