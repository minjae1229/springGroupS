...
//	}
	...
	public String test3Get(Model model, @RequestParam(name = "mid") String id,
	...
	public String test4Get(Model model, @RequestParam(name = "mid") String id, @RequestParam(name = "pwd") String passwd,
	...
	public String test24Get(Model model, @PathVariable String id, @PathVariable String temp,
...
//	@RequestMapping(value = "/mapping/test31", method = RequestMethod.POST)
	...
	public String test31Post(Model model, HoewonVO vo, String mid, String pwd, String name, String strGender, int age,
			String nickName) {
		vo.setMid(mid);
		vo.setPwd(pwd);
		vo.setName(name);
...
//AJax 폼보기
	...
	// AJax 처리 결과를 배열로 전송 String 배열
	// 서비스 구현객체 처리에서만 배열 쓸건데 굳이 선언해야 하는가????
	@ResponseBody
...
//		return strArray;
	...
	// ajax처리결과를 객체배열로 전송... ArrayList<String>
	@ResponseBody
	...
	// ajax처리결과를 객체배열로 전송... Map<Object, Object>
	@ResponseBody
	...
	public String mailFormPost(MailVO vo, HttpServletRequest request) throws MessagingException {
		...
		// FileSystemResource file = new FileSystemResource("C:\\Users\\minja\\Desktop\\springGroup\\springframework\\works\\springGroupS\\src\\main\\webapp\\resources\\images\\main.jpg");
