...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="http://192.168.0.9:9090/springGroupS/" class="w3-bar-item w3-button w3-padding-large">HOME</a>
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        ...
        <a href="${ctp}/study1/aop/aopmenu" class="w3-bar-item w3-button">AOP(service)</a>
        <a href="${ctp}/study1/xml/xmlMenu" class="w3-bar-item w3-button">XML 값 주입 Test</a>
        <a href="${ctp}/user/userList" class="w3-bar-item w3-button">유저 리스트</a>
        <a href="${ctp}/user2/userList" class="w3-bar-item w3-button">유저2 리스트</a>
